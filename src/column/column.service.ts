...
import { BadRequestException, Injectable, NotFoundException } from '@nestjs/common'; // 서비스 데코레이터
...
export class ColumnService { // 서비스 클래스
  ...
  async create(boardId: number,createColumnDto: CreateColumnDto) { // 데이터 생성 메서드 
